...
class HandlerCvUpdateById final : public HttpHandlerJsonBase {
public:
    static constexpr std::string_view kName = "handler-cv-update-by-id";

    HandlerCvUpdateById(const ComponentConfig& config, const ComponentContext& component_context);
