...
class HandlerCvGet final : public HttpHandlerJsonBase {
public:
    static constexpr std::string_view kName = "handler-cv-get";

    HandlerCvGet(const ComponentConfig& config, const ComponentContext& component_context);
